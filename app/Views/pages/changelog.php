        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu active">
                    <a href="/pages/changelog" aria-expanded="true" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 align-self-center order-md-0 order-1">
                            ...
                            <p class="">KHDTK DATABASE SYSTEM</p>
                        </div>
                        <div class="col-md-6 order-md-0 order-0">
                            <div class="banner-img">
                                <img src="<?= base_url('dashboard/assets/img/pc.gif') ?>" class="d-block" alt="header-image">
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="fqheadingOne">
                                            <div class="mb-0" data-toggle="collapse" role="navigation" data-target="#fqcollapseOne" aria-expanded="false" aria-controls="fqcollapseOne">
                                                ...
                                                </svg> <span class="faq-q-title">Ver. 1. 0. alpha</span>
                                            </div>
                                        </div>
                                        <div id="fqcollapseOne" class="collapse" aria-labelledby="fqheadingOne" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>- First program build.</p>
                                                <p>- Adding framework database.</p>
                                                <p>- Query database. </p>
                                                <p>- Create and read feature. </p>
                                                <p>- Install datatable on feature. </p>
                                                <p>- Minor update, etc. </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-header" id="fqheadingTwo">
                                            <div class="mb-0" data-toggle="collapse" role="navigation" data-target="#fqcollapseTwo" aria-expanded="false" aria-controls="fqcollapseTwo">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-code">
                                                    <polyline points="16 18 22 12 16 6"></polyline>
                                                    <polyline points="8 6 2 12 8 18"></polyline>
                                                </svg> <span class="faq-q-title">Ver. 1. 1. - 1. 6. alpha</span>
                                            </div>
                                        </div>
                                        <div id="fqcollapseTwo" class="collapse" aria-labelledby="fqheadingTwo" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>- Fix bug on framework database.</p>
                                                <p>- Query database fixation.</p>
                                                <p>- Add delete feature. </p>
                                                <p>- Customize data table. </p>
                                                <p>- Major update, etc. </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-header" id="fqheadingThree">
                                            <div class="mb-0" data-toggle="collapse" role="navigation" data-target="#fqcollapseThree" aria-expanded="false" aria-controls="fqcollapseThree">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-code">
                                                    <polyline points="16 18 22 12 16 6"></polyline>
                                                    <polyline points="8 6 2 12 8 18"></polyline>
                                                </svg> <span class="faq-q-title">Ver. 1. 7. beta</span>
                                            </div>
                                        </div>
                                        <div id="fqcollapseThree" class="collapse" aria-labelledby="fqheadingThree" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>- Upgrade UI base on material design. </p>
                                                <p>- Bootstrap 4.1.2. </p>
                                                <p>- Add support for Model, View, and Controller. </p>
                                                <p>- Fixation on create, read, and delete features. </p>
                                                <p>- Inline edit on create, read, and delete features. </p>
                                                <p>- Minor update, etc. </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-header" id="fqheadingFour">
                                            <div class="mb-0" data-toggle="collapse" role="navigation" data-target="#fqcollapseFour" aria-expanded="false" aria-controls="fqcollapseFour">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-code">
                                                    <polyline points="16 18 22 12 16 6"></polyline>
                                                    <polyline points="8 6 2 12 8 18"></polyline>
                                                </svg> <span class="faq-q-title">Ver. 1. 8. beta</span>
                                            </div>
                                        </div>
                                        <div id="fqcollapseFour" class="collapse" aria-labelledby="fqheadingFour" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>- Update layout base on menu.</p>
                                                <p>- First create web GIS.</p>
                                                <p>- Fixation and costomizing datatable layout.</p>
                                                <p>- First install framework, based On CodeIgniter 4.1.2.</p>
                                                <p>- Fixation on Models, Views, and Controllers.</p>
                                                <p>- Interactive interface within create, read, update, and delete features.</p>
                                                <p>- Minor update, etc. </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-header" id="fqheadingFive">
                                            <div class="mb-0" data-toggle="collapse" role="navigation" data-target="#fqcollapseFive" aria-expanded="false" aria-controls="fqcollapseFive">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-code">
                                                    <polyline points="16 18 22 12 16 6"></polyline>
                                                    <polyline points="8 6 2 12 8 18"></polyline>
                                                </svg> <span class="faq-q-title">Ver. 1. 9. beta</span>
                                            </div>
                                        </div>
                                        <div id="fqcollapseFive" class="collapse" aria-labelledby="fqheadingFive" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>- Intall notification on within create, read, update, and delete features.</p>
                                                <p>- First install authentication feature, including login and register.</p>
                                                <p>- Fixation on Web GIS feature.</p>
                                                <p>- KHDTK data deployed at Web GIS.</p>
                                                <p>- Install security feature via CSRF (Cross Site Request Forgery) on each input.</p>
                                                <p>- Minor update, etc. </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-header" id="fqheadingSix">
                                            <div class="mb-0" data-toggle="collapse" role="navigation" data-target="#fqcollapseSix" aria-expanded="true" aria-controls="fqcollapseSix">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-code">
                                                    <polyline points="16 18 22 12 16 6"></polyline>
                                                    <polyline points="8 6 2 12 8 18"></polyline>
                                                </svg> <span class="faq-q-title">Ver. 2. 0. (open beta)</span>
                                            </div>
                                        </div>
                                        <div id="fqcollapseSix" class="collapse show" aria-labelledby="fqheadingSix" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <p>- Fixation on authentication feature, base on Myth;Auth Library. Include login, register, and user activation.</p>
                                                <p>- Multi user feature by its role.</p>
                                                <p>- Install server-base validation on each data input</p>
                                                <p>- Fixation database queries.</p>
                                                <p>- Syncronize database with Web GIS data.</p>
                                                <p>- Fixation on validation input.</p>
                                                <p>- Fix UX for all major data input.</p>
                                                <p>- Minor update, etc. </p>
                                            </div>
                                        </div>
                                    </div>
